...
><p><font>The *16S rRNA gene amplion - upstream data analysis* from **Biome-shiny Biodata.pt Crash Course** requires the participants to be familiar with the **R programming language and environment**.</p><font> 
